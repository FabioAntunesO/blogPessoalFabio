package org.generation.blogFabio.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket (DocumentationType.SWAGGER_2)
				...
				.basePackage("org.generation.blogFabio.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				...
				.licenseUrl("https://github.com/FabioAntunesO")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Fábio", "https://github.com/FabioAntunesO", "fabio.fao03@gmail.com");
	}
